---
title: "Syllabus, CMPSC 9, Fall 2025"
layout: handout
ready: true
---
...
* **Course Web Site**: <https://ucsb-cs9.github.io/f25/>
* **Instructor**:  [Richert Wang](http://www.cs.ucsb.edu/~richert)
   * Email is richert@ucsb.edu, BUT please use [Piazza](https://piazza.com/ucsb/fall2025/cmpsc9) for course related communication.
* **Lecture**: Tu Th 11:00am-12:15pm (EMBAR HALL)
* **TAs**:  {{site.ta_list_full}} (contact via Piazza)
* **Mentors**: {{site.mentors_list}} (contact via Piazza)
* **Lab** (50 minute lab sections): Wednesdays 11am, 1pm, 2pm, 4pm (SSMS 1301)
* **Office Hours**: See <https://ucsb-cs9.github.io/f25/info/office_hours/>
...
**Prerequisite:** CMPSC 8 or CMPSC W 8 or ENGR 3 or ENGR W 3 or ECE 3 with a grade of C or better. 
...
|-----------------------------------------------|---------------------------|
| Academic Integrity Contract (Tuesday 10/7)    | 1 %                       |
| Midterm (Thursday 10/30), 11am - 12:15pm      | 35 %                      |
| Final (Wednesday 12/10), 12:00pm - 2:00pm     | 35 %                      |
| Homeworks                                     | 9 %                       |
| Labs                                          | 20 %                      |
...
* All labs must be submitted by the due date. There will be a 24-hour late window open on Gradescope for each lab unless stated otherwise. Submissions during the late window period will have a **20%** deduction from your grade. We will only consider your most recent submission.
