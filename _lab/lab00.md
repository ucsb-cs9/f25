...
assigned: 2025-09-25 23:59:59.59-7
due: 2025-10-05 23:59:59.59-7
---
...
We will use Gradescope to grade all your homeworks, quizzes, and lab assignments. I have manually added everyone (using your @umail.ucsb.edu accounts) currently enrolled in the course to the Gradescope system. You should have received an email notification with instructions about logging into Gradescope. **Note that if your Gradescope email is something other than your @umail.ucsb.edu account, you can link your @umail.ucsb.edu account in your Gradescope account settings.** Once you follow the instructions to set your password, you should have access to our course on Gradescope. You should see "CMPSC 9" in your Fall 2025 courses.
...
We are offering in-person lab sections this quarter. These computers are Windows machines with Python 3+ already installed. **In general, it is acceptable (and expected) to conduct your work on your own computer for this class.** 

The lab workstations **WILL NOT** save your work such that when you log in / log out. If you plan on using these machines to do your work, it is a good idea to create back up versions of your work in case you plan on working on your personal computer - uploading versions of your work on Gradescope is a great way to do this since you can download / upload your work on any computer.
